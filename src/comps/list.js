...
import Particular_poke from "./display";
import "./list.css";
...
function ListDisplay() {
  ...
  const [nexturl, setnexturl] = useState(localStorage.getItem("next_url") || "https://pokeapi.co/api/v2/pokemon/");
  useEffect(() => {
          ...
          poke.map((obj,i) => (
            <div key={i} className="container">
              <div className="card">
                <div className="imgBx">
                  <img
                    src={`https://courses.cs.washington.edu/courses/cse154/webservices/pokedex/sprites/${obj.name.toLowerCase() || {icon}}.png`}
                  />
                </div>
